...
classes = { 0:'Hız Limiti 20 km/h',
            1:'Hız Limiti 30 km/h',
            2:'Hız Limiti 50 km/h',
            3:'Hız Limiti 60 km/h',
            4:'Hız Limiti 70 km/h',
            5:'Hız Limiti 80 km/h',
            6:'Hız Limiti Sonu (80km/h)',
            7:'Hız Limiti 100 km/h',
            8:'Hız Limiti 120 km/h',
            9:'Sollama Yasağı',
            10:'Kamyonlar İçin Sollama Yasağı',
            11:'Ana Yol Tali Yol',
            12:'Öncelikli Yol',
            13:'Yol Ver',
            14:'Dur',
            ...
            21:'Ard Arda Tehlikeli Viraj',
            22:'Kasisli Yol',
            23:'Kaygan Yol',
            24:'Sağdan Daralan Yol',
            25:'Yol Çalışması',
            26:'Trafik İşaretleri',
            27:'Yaya Geçidi',
            28:'Okul Geçidi',
            29:'Bisiklet Geçidi',
            30:'Buzlanma Tehlikesi',
            31:'Vahşi Hayvan Geçebilir',
            32:'Sınırlama ve Kısıtlamaların Sonu',
            33:'İlerden Sağa Mecburi Yön',
            34:'İlerden Sola Mecburi Yön',
...
print("Bulunan sınıf sayısı:", len(myList))
noOfClasses = len(myList)
print("Sınıflar İçeri Aktarılıyor.....")
for x in range(0, len(myList)):
    myPicList = os.listdir(path + "/" + str(count))
    train_number.append(len(myPicList))
    class_num.append(classes[int(x)])
    for y in myPicList:
...
for i in range(cols):
    for j, row in data.iterrows():
        ...
        axs[j-1][i].imshow(x_selected[random.randint(0, len(x_selected) - 1), :, :], cmap=plt.get_cmap("gray"))
        axs[j-1][i].axis("off")
        if i == 2:
            axs[j][i].set_title(classes[int(j)])
